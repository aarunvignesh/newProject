	...
	newRandomTextGenerate:function(user){
		...
		obj.then(function(){
			var msg='<div style="font-size: 20px;font-family: cursive;"><span>Hi,</span>'
				...
				'<span>security check.</span><br/><span> Your verification code is <b style="font-family: monospace;color: red;">'+user.randomEmailValidationText+ '</b></div><br/><div style="font-size: 17px;font-family: cursive;">Thanks and Regards,<br/>Pingme Team</div>';
